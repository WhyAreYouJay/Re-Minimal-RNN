...
if __name__ == "__main__":
    ...
    batch_sizes = [64,128]
    lrs = [10**-4,10**-3]
    taus = {"halfcheetah":{"medium": 0.9, "medium-replay": 0.9, "medium-expert": 0.9},"hopper":{"medium": 0.999, "medium-replay": 0.999, "medium-expert": 0.9},"walker2d":{"medium": 0.9, "medium-replay": 0.99, "medium-expert": 0.99}}
